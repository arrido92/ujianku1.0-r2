<template>
    ...
    <div class="mt-5 mb-5 container-fluid">
      <div class="row">
        <div class="col-md-12">
          <Link href="/admin/exams" class="mb-3 border-0 shadow btn btn-md btn-primary">
          ...
          <div class="border-0 shadow card">
            <div class="card-body">
              ...
              <hr />
              <Link :href="`/admin/exams/${exam.id}/questions/create`" class="border-0 shadow btn btn-md btn-primary me-2">
                <i class="fa fa-plus-circle"></i> Tambah Soal
              </Link>
              <Link :href="`/admin/exams/${exam.id}/questions/import-excel`" class="text-white border-0 shadow btn btn-md btn-success me-2">
                <i class="fa fa-file-archive"></i> Import ZIP
              </Link>
              <Link :href="`/admin/exams/${exam.id}/questions/import-word`" class="text-white border-0 shadow btn btn-md btn-info">
                    ...
                    <template v-for="(group, groupKey) in groupedQuestions" :key="groupKey">
                      ...
                      <tr v-for="(question, index) in group.questions" :key="groupKey + '-' + index">
                        ...
                        <td class="text-center">
                          <Link :href="`/admin/exams/${exam.id}/questions/${question.id}/edit`" class="border-0 shadow btn btn-sm btn-info me-2">
      ...
      destroy(examId, questionId) {
        Swal.fire({
          ...
          if (result.isConfirmed) {
            router.delete(`/admin/exams/${examId}/questions/${questionId}/destroy`, {
              onSuccess: () => {

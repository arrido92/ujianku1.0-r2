              ...
              <div class="table-responsive">
                <table class="table mb-0 rounded table-bordered table-centered table-nowrap">
                  ...
                  <tbody>
                    ...
                    <!-- Data Rows -->
                    <tr v-else v-for="(classroom, index) in classrooms.data" :key="classroom.id">
                      <td class="text-center fw-bold">
                        {{ index + 1 + (classrooms.current_page - 1) * classrooms.per_page }}
                      </td>
                      ...
                      <td class="text-center">
                        ...
                        <!-- Delete Button -->
                        <button
                          @click.prevent="destroy(classroom.id)"
  ...
  export default {
    ...
    setup() {
      ...
      const handleSearch = () => {
        ...
        router.get("/admin/classrooms", { q: search.value.trim() });
      };

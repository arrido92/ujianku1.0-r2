<template>
    ...
    <div class="mt-5 mb-5 container-fluid">
      <div class="row">
        <div class="col-md-12">
          <Link href="/teacher/exams" class="mb-3 border-0 shadow btn btn-md btn-primary" type="button">
...
<script>
import LayoutAdmin from "../../../Layouts/Teacher.vue";

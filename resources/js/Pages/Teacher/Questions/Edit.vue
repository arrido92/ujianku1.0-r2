<template>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <Link :href="`/teacher/exams/${exam.id}`" class="mb-3 border-0 shadow btn btn-md btn-primary" @click.prevent="goBack">
...
export default {
  ...
  setup(props) {
    ...
    const goBack = () => {
      router.visit(`/teacher/exams/${props.exam.id}`, { preserveState: false });
    };
    ...
    router.put(`/teacher/exams/${props.exam.id}/questions/${props.question.id}/update`, form, {

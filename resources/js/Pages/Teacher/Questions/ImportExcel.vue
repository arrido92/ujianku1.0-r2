<template>
    ...
    <div class="mt-5 mb-5 container-fluid">
        <div class="row">
            <div class="col-md-12">
                <Link :href="`/teacher/exams/${exam.id}`" class="mb-3 border-0 shadow btn btn-md btn-primary me-3">
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            ...
            router.post(`/teacher/exams/${props.exam.id}/questions/import-excel`, formData, {
                headers: {

...
export default {
  ...
  mounted() {
    ...
    this.menuItems = [
      { label: 'Dashboard', route: '/admin/dashboard', icon: 'bi bi-house-fill' },
      { label: 'Mata Pelajaran', route: '/admin/lessons', icon: 'bi bi-bookmarks' },
      { label: 'Kelas', route: '/admin/classrooms', icon: 'bi bi-back' },
      { label: 'Sesi', route: '/admin/sesis', icon: 'bi bi-stopwatch' },
      { label: 'Siswa', route: '/admin/students', icon: 'bi bi-people-fill' },
      { label: 'Soal Ujian', route: '/admin/exams', icon: 'bi bi-pencil-square' },
      { label: 'Jadwal Ujian', route: '/admin/exam_sessions', icon: 'bi bi-calendar-event' },
      { label: 'Monitoring Ujian', route: '/admin/monitoring', icon: 'bi bi-display' },
      { label: 'Login Peserta', route: '/admin/login-peserta', icon: 'bi bi-box-arrow-in-right' },
      { label: 'Laporan Nilai', route: '/admin/reports', icon: 'bi bi-graph-up-arrow' },
      { label: 'Pengaturan Aplikasi', route: '/admin/app-settings', icon: 'bi bi-sliders' },
      { label: 'Kelola Pengguna', route: '/admin/admin-manager', icon: 'bi bi-person-gear' },
    ];
  },
};
</script>
